...
5. **Cómo llegar** (`marina.png`) · Marina Miramar 3:00 p.m. + lanchas a Punta de Palma, Maps/Waze.
...
- [ ] Revisar/afinar los links de **Google Maps / Waze** del Marina Miramar (sección `location`).
